    ...
    <div style={{ minHeight: '100vh', background: '#f5f5f5', overflowX: 'hidden' }}>
      ...
      <div className="detalhes-grid">
        ...
        <div>
          ...
          {/* WHATSAPP CONTATO */}
          {isAnuncio && !isSeller && auction.whatsapp_number && (
            <div style={{background:'white',borderRadius:'16px',padding:'clamp(16px,4vw,24px)',marginTop:'16px'}}>
              <h3 style={{margin:'0 0 14px 0',fontSize:'clamp(15px,4vw,18px)',color:'#1a202c',display:'flex',alignItems:'center',gap:'8px'}}>
                <span>📱</span> Contato com o Vendedor
              </h3>
              <a
                href={'https://wa.me/' + auction.whatsapp_number.replace(/[^0-9]/g,'')}
                target="_blank"
                ...
                style={{
                  ...
                  borderRadius:'14px',fontSize:'clamp(15px,4vw,18px)',
                  fontWeight:'900',boxShadow:'0 4px 16px rgba(37,211,102,0.4)',
