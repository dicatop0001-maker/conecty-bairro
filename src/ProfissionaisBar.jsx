...
const [showScrollHint, setShowScrollHint] = useState(() => !localStorage.getItem('pb_scroll_seen'))
...
useEffect(() => {
  if (showScrollHint) {
    const t = setTimeout(() => {
      ...
      localStorage.setItem('pb_scroll_seen', '1')
    }, 6000)
...
onTouchStart={handleTrackScroll}
>
{profissoes.map((prof) => {
